...
\textbf{Tip:} 
\begin{itemize}
	\item Wenn Max/Min bestimmen werden soll, prüfe zuerst ob f ein Max/Min besitzt. Dies ist der Fall, wenn $f$ stetig ist auf ganzem Definitionsbereich (beachte Übergang bei Fallunterscheidungen) \underline{und} wenn der Definitionsbereich kompakt ist!
